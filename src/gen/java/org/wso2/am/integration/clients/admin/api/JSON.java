...
import org.wso2.am.integration.clients.admin.api.v16.dto.*;
...
public class JSON {
    ...
    public static GsonBuilder createGson() {
        GsonFireBuilder fireBuilder = new GsonFireBuilder()
          .registerTypeSelector(ThrottleLimitDTO.class, new TypeSelector() {
            @Override
            public Class getClassForElement(JsonElement readElement) {
                Map classByDiscriminatorValue = new HashMap();
                classByDiscriminatorValue.put("BandwidthLimit".toUpperCase(), BandwidthLimitDTO.class);
                classByDiscriminatorValue.put("RequestCountLimit".toUpperCase(), RequestCountLimitDTO.class);
                classByDiscriminatorValue.put("ThrottleLimitDTO".toUpperCase(), ThrottleLimitDTO.class);
