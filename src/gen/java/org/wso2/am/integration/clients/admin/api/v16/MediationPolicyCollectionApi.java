...
import org.wso2.am.integration.clients.admin.api.v16.dto.MediationListDTO;
...
public class MediationPolicyCollectionApi {
    ...
    public MediationListDTO policiesMediationGet(Integer limit, Integer offset, String query, String accept, String ifNoneMatch) throws ApiException {
        ApiResponse<MediationListDTO> resp = policiesMediationGetWithHttpInfo(limit, offset, query, accept, ifNoneMatch);
        return resp.getData();
    }
     ...
     */
    public com.squareup.okhttp.Call policiesMediationGetAsync(Integer limit, Integer offset, String query, String accept, String ifNoneMatch, final ApiCallback<MediationListDTO> callback) throws ApiException {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call policiesMediationPostCall(MediationDTO body, String contentType, String ifMatch, String ifUnmodifiedSince, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call policiesMediationPostValidateBeforeCall(MediationDTO body, String contentType, String ifMatch, String ifUnmodifiedSince, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public MediationDTO policiesMediationPost(MediationDTO body, String contentType, String ifMatch, String ifUnmodifiedSince) throws ApiException {
        ApiResponse<MediationDTO> resp = policiesMediationPostWithHttpInfo(body, contentType, ifMatch, ifUnmodifiedSince);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<MediationDTO> policiesMediationPostWithHttpInfo(MediationDTO body, String contentType, String ifMatch, String ifUnmodifiedSince) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call policiesMediationPostAsync(MediationDTO body, String contentType, String ifMatch, String ifUnmodifiedSince, final ApiCallback<MediationDTO> callback) throws ApiException {
