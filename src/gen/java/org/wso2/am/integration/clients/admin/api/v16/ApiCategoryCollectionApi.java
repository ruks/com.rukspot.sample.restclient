...
import org.wso2.am.integration.clients.admin.api.v16.dto.APICategoryListDTO;
...
public class ApiCategoryCollectionApi {
     ...
     */
    public com.squareup.okhttp.Call apiCategoriesGetCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call apiCategoriesGetValidateBeforeCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = apiCategoriesGetCall(progressListener, progressRequestListener);
        return call;
    ...
    public APICategoryListDTO apiCategoriesGet() throws ApiException {
        ApiResponse<APICategoryListDTO> resp = apiCategoriesGetWithHttpInfo();
        return resp.getData();
    }
    ...
    public ApiResponse<APICategoryListDTO> apiCategoriesGetWithHttpInfo() throws ApiException {
        com.squareup.okhttp.Call call = apiCategoriesGetValidateBeforeCall(null, null);
     ...
     */
    public com.squareup.okhttp.Call apiCategoriesGetAsync(final ApiCallback<APICategoryListDTO> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = apiCategoriesGetValidateBeforeCall(progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<APICategoryListDTO>(){}.getType();
