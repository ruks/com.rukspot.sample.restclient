...
import org.wso2.am.integration.clients.admin.api.v16.dto.MediationDTO;
...
public class MediationPolicyIndividualApi {
    ...
    public MediationDTO policiesMediationMediationPolicyIdGet(String mediationPolicyId, String accept, String ifNoneMatch, String ifModifiedSince) throws ApiException {
        ApiResponse<MediationDTO> resp = policiesMediationMediationPolicyIdGetWithHttpInfo(mediationPolicyId, accept, ifNoneMatch, ifModifiedSince);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call policiesMediationMediationPolicyIdGetAsync(String mediationPolicyId, String accept, String ifNoneMatch, String ifModifiedSince, final ApiCallback<MediationDTO> callback) throws ApiException {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call policiesMediationMediationPolicyIdPutCall(String mediationPolicyId, MediationDTO body, String contentType, String ifMatch, String ifUnmodifiedSince, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call policiesMediationMediationPolicyIdPutValidateBeforeCall(String mediationPolicyId, MediationDTO body, String contentType, String ifMatch, String ifUnmodifiedSince, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public MediationDTO policiesMediationMediationPolicyIdPut(String mediationPolicyId, MediationDTO body, String contentType, String ifMatch, String ifUnmodifiedSince) throws ApiException {
        ApiResponse<MediationDTO> resp = policiesMediationMediationPolicyIdPutWithHttpInfo(mediationPolicyId, body, contentType, ifMatch, ifUnmodifiedSince);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<MediationDTO> policiesMediationMediationPolicyIdPutWithHttpInfo(String mediationPolicyId, MediationDTO body, String contentType, String ifMatch, String ifUnmodifiedSince) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call policiesMediationMediationPolicyIdPutAsync(String mediationPolicyId, MediationDTO body, String contentType, String ifMatch, String ifUnmodifiedSince, final ApiCallback<MediationDTO> callback) throws ApiException {
