...
public class GraphQLAPITestCase extends RestAPITestCase {
    ...
    public void run(TestCase testCase, String tenant) throws Exception {
        ...
        String originalPayload = Utils.readFile("graphql.json");
        File schema = Utils.getFile("schema.graphql");
        ...
        APIDTO apiDtoResponse = publisherClient
                .createAndPublishAPI(apidto, apiName, Utils.getTeantUsername(testCase.getPublisher(), tenant), schema);
